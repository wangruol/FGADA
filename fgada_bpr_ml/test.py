...
if (os.path.exists(path_save_model_base)):
    print("Model:", path_save_model_base,similarity,b)
else:
...
def all_metrics(top_k):
    ...
    for epoch in ['best']:
        ...
        PATH_model_u = path_save_model_base + '/user_emb' +str(similarity) +str(b) + '3.npy'
        user_e = np.load(PATH_model_u)
        PATH_model_i = path_save_model_base + '/item_emb' + str(similarity) +str(b) + '3.npy'

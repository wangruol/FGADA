...
parser.add_argument('--runid', type=str, default = "fgada_gccf_lastfm")
...
def all_metrics(top_k): 
    ...
    for epoch in ['best']:
        ...
        PATH_model_u = path_save_model_base + '/user_emb' + str(similarity) +str(b)+ '2.npy'
        user_e = np.load(PATH_model_u)
        PATH_model_i = path_save_model_base + '/item_emb' + str(similarity) +str(b)+ '2.npy'
